...
TransformerPairConstSharedPtr FilterConfig::findTransformers(const Http::RequestHeaderMap& headers) const {
...
TransformationFilterStats FilterConfig::generateStats(const std::string& prefix, Stats::Scope& scope) {
