...
type TransformationTemplate struct {
	...
	// data_source("my_file") }}').
	DataSources map[string]*v33.DataSource `protobuf:"bytes,17,rep,name=data_sources,json=dataSources,proto3" json:"data_sources,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_rawDesc = "" +
	"\n" +
	"Japi/envoy/config/filter/http/transformation/v2/transformation_filter.proto\x12\x18envoy.api.v2.filter.http\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x17validate/validate.proto\x1a!xds/type/matcher/v3/matcher.proto\x1a,envoy/config/route/v3/route_components.proto\x1a\"envoy/type/matcher/v3/string.proto\x1a$envoy/config/core/v3/extension.proto\x1a\x1fenvoy/config/core/v3/base.proto\"\xbf\x02\n" +
	"\x15FilterTransformations\x12V\n" +
	"\x0ftransformations\x18\x01 \x03(\v2,.envoy.api.v2.filter.http.TransformationRuleR\x0ftransformations\x126\n" +
	"\amatcher\x18\x04 \x01(\v2\x1c.xds.type.matcher.v3.MatcherR\amatcher\x12\x1d\n" +
	"\x05stage\x18\x02 \x01(\rB\a\xfaB\x04*\x02\x18\n" +
	"R\x05stage\x129\n" +
	"\x19log_request_response_info\x18\x03 \x01(\bR\x16logRequestResponseInfo\x12<\n" +
	"\x1aauto_websocket_passthrough\x18\x05 \x01(\bR\x18autoWebsocketPassthrough\"\xc7\x04\n" +
	"\x12TransformationRule\x12A\n" +
	"\x05match\x18\x01 \x01(\v2!.envoy.config.route.v3.RouteMatchB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05match\x12q\n" +
	...
	"#on_stream_completion_transformation\x18\x04 \x01(\v2(.envoy.api.v2.filter.http.TransformationR onStreamCompletionTransformation\"\xe0\t\n" +
	...
	"\x0ftransformations\x18\x04 \x03(\v2B.envoy.api.v2.filter.http.RouteTransformations.RouteTransformationR\x0ftransformations\x1a\xdd\x06\n" +
	...
	"\x0eresponse_match\x18\x03 \x01(\v2P.envoy.api.v2.filter.http.RouteTransformations.RouteTransformation.ResponseMatchH\x00R\rresponseMatch\x126\n" +
	"\amatcher\x18\x05 \x01(\v2\x1c.xds.type.matcher.v3.MatcherR\amatcher\x1a\xb7\x02\n" +
	"\fRequestMatch\x127\n" +
	"\x05match\x18\x01 \x01(\v2!.envoy.config.route.v3.RouteMatchR\x05match\x12_\n" +
	...
	"\x05match\x12\x03\xf8B\x01\"\xab\x01\n" +
	"\x0fResponseMatcher\x12>\n" +
	"\aheaders\x18\x01 \x03(\v2$.envoy.config.route.v3.HeaderMatcherR\aheaders\x12X\n" +
	"\x15response_code_details\x18\x02 \x01(\v2$.envoy.type.matcher.v3.StringMatcherR\x13responseCodeDetails\"\xc0\x01\n" +
	"\x1aResponseTransformationRule\x12?\n" +
	"\x05match\x18\x01 \x01(\v2).envoy.api.v2.filter.http.ResponseMatcherR\x05match\x12a\n" +
	"\x17response_transformation\x18\x02 \x01(\v2(.envoy.api.v2.filter.http.TransformationR\x16responseTransformation\"\x88\x04\n" +
	...
	"\x15header_body_transform\x18\x02 \x01(\v2-.envoy.api.v2.filter.http.HeaderBodyTransformH\x00R\x13headerBodyTransform\x12[\n" +
	"\x12transformer_config\x18\x03 \x01(\v2*.envoy.config.core.v3.TypedExtensionConfigH\x00R\x11transformerConfig\x12Y\n" +
	"\x11ai_transformation\x18\x05 \x01(\v2*.envoy.api.v2.filter.http.AiTransformationH\x00R\x10aiTransformation\x12U\n" +
	...
	"extractors\x12d\n" +
	"\fdata_sources\x18\x11 \x03(\v2A.envoy.api.v2.filter.http.TransformationTemplate.DataSourcesEntryR\vdataSources\x12/\n" +
	"\x14data_source_max_size\x18\x12 \x01(\rR\x11dataSourceMaxSize\x12W\n" +
	...
	"\x0fmerge_json_keys\x18\r \x01(\v2'.envoy.api.v2.filter.http.MergeJsonKeysH\x00R\rmergeJsonKeys\x12q\n" +
	...
	"\x11escape_characters\x18\f \x01(\bR\x10escapeCharacters\x12)\n" +
	"\x10string_delimiter\x18\x0e \x01(\tR\x0fstringDelimiter\x12k\n" +
	"\x10span_transformer\x18\x0f \x01(\v2@.envoy.api.v2.filter.http.TransformationTemplate.SpanTransformerR\x0fspanTransformer\x1ac\n" +
	"\x0fExtractorsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12:\n" +
	"\x05value\x18\x02 \x01(\v2$.envoy.api.v2.filter.http.ExtractionR\x05value:\x028\x01\x1a`\n" +
	"\x10DataSourcesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x126\n" +
	"\x05value\x18\x02 \x01(\v2 .envoy.config.core.v3.DataSourceR\x05value:\x028\x01\x1ab\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12<\n" +
	"\x05value\x18\x02 \x01(\v2&.envoy.api.v2.filter.http.InjaTemplateR\x05value:\x028\x01\x1a`\n" +
	"\x0eHeaderToAppend\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12<\n" +
	"\x05value\x18\x02 \x01(\v2&.envoy.api.v2.filter.http.InjaTemplateR\x05value\x1a\xc2\x01\n" +
	...
	"\x05value\x18\x03 \x01(\v2&.envoy.api.v2.filter.http.InjaTemplateR\x05value\x12\"\n" +
	"\rjson_to_proto\x18\x04 \x01(\bR\vjsonToProto\x1aM\n" +
	"\x0fSpanTransformer\x12:\n" +
	"\x04name\x18\x01 \x01(\v2&.envoy.api.v2.filter.http.InjaTemplateR\x04name\"2\n" +
	...
	"\vPassthrough\"\x17\n" +
	"\x15MergeExtractorsToBody\"\xd7\x02\n" +
	"\rMergeJsonKeys\x12R\n" +
	"\tjson_keys\x18\x02 \x03(\v25.envoy.api.v2.filter.http.MergeJsonKeys.JsonKeysEntryR\bjsonKeys\x1ax\n" +
	"\x13OverridableTemplate\x12:\n" +
	"\x04tmpl\x18\x01 \x01(\v2&.envoy.api.v2.filter.http.InjaTemplateR\x04tmpl\x12%\n" +
	"\x0eoverride_empty\x18\x02 \x01(\bR\roverrideEmpty\x1ax\n" +
	"\rJsonKeysEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12Q\n" +
	"\x05value\x18\x02 \x01(\v2;.envoy.api.v2.filter.http.MergeJsonKeys.OverridableTemplateR\x05value:\x028\x01\"G\n" +
	"\x13HeaderBodyTransform\x120\n" +
	"\x14add_request_metadata\x18\x01 \x01(\bR\x12addRequestMetadata\"n\n" +
	"\fFieldDefault\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value\x12\x1a\n" +
	"\boverride\x18\x03 \x01(\bR\boverride\"\xe5\x01\n" +
	"\x10PromptEnrichment\x12L\n" +
	"\aprepend\x18\x02 \x03(\v22.envoy.api.v2.filter.http.PromptEnrichment.MessageR\aprepend\x12J\n" +
	"\x06append\x18\x03 \x03(\v22.envoy.api.v2.filter.http.PromptEnrichment.MessageR\x06append\x1a7\n" +
	"\aMessage\x12\x12\n" +
	"\x04role\x18\x01 \x01(\tR\x04role\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\"\xee\x01\n" +
	"\x10AiTransformation\x122\n" +
	"\x15enable_chat_streaming\x18\x01 \x01(\bR\x13enableChatStreaming\x12M\n" +
	"\x0efield_defaults\x18\x02 \x03(\v2&.envoy.api.v2.filter.http.FieldDefaultR\rfieldDefaults\x12W\n" +
	"\x11prompt_enrichment\x18\x03 \x01(\v2*.envoy.api.v2.filter.http.PromptEnrichmentR\x10promptEnrichmentB\x8f\x01\n" +
	"&io.envoyproxy.envoy.api.v2.filter.httpB\x19TransformationFilterProtoP\x01ZHgithub.com/solo-io/envoy-gloo/go/config/filter/http/transformation/v2;v2b\x06proto3"

var (
	file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_rawDescOnce sync.Once
	file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_rawDescData []byte
)
...
func file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_rawDescGZIP() []byte {
	file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_rawDescOnce.Do(func() {
		file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_rawDesc), len(file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_rawDesc)))
	})
...
var file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_goTypes = []any{
...
func file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_init() {
	...
	file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_msgTypes[5].OneofWrappers = []any{
	...
	file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_msgTypes[6].OneofWrappers = []any{
		(*Extraction_Header)(nil),
		(*Extraction_Body)(nil),
	}
	file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_msgTypes[7].OneofWrappers = []any{
	...
	file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_msgTypes[17].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_rawDesc), len(file_api_envoy_config_filter_http_transformation_v2_transformation_filter_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   29,
			NumExtensions: 0,
			NumServices:   0,
