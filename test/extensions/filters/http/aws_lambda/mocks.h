...
public:
  ...
  MOCK_METHOD(void, fetch,
              (const envoy::config::core::v3::HttpUri& uri,
                      ...
                      StsFetcher::SuccessCallback success, StsFetcher::FailureCallback failure));
};

class MockStsCallbacks : public StsCredentialsProvider::Callbacks {
public:
  MOCK_METHOD(void, onSuccess, (std::shared_ptr<const Envoy::Extensions::Common::Aws::Credentials>));
