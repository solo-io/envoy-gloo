...
def envoy_gloo_dependencies():
    ...
    _repository_impl("envoy", patches = [
            ...
            "@envoy_gloo//bazel/foreign_cc:8feb24-cves-25.patch",
            "@envoy_gloo//bazel/foreign_cc:http2-continuation-nghttp2-upstream-cve.patch",
            "@envoy_gloo//bazel/foreign_cc:http2-continuation-nghttp2-cve.patch",
        ])
